...
|----------|-------------|
| `helloworld.py` | Prints a basic Hello World example |
| `loops.py` | Demonstrates `for`/`while` loops |
| `functions.py` | Shows how to define and use functions |
| `lamda.py` | Lambda function examples |
| `MapAndFilter.py` | Usage of `map()` and `filter()` |
| `Dictionary.py` | Dictionary data structure examples |
| `Sets.py` | Python set examples |
| `sliceOperators.py` | Slicing operations for strings/lists |
| `else-if.py` | Conditional statements (`if` / `elif` / `else`) |
| `fstring.py` | Examples of f-string formatting |
| `Scope&Global.py` | Scope and global variable usage |
